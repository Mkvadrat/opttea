...
$rezult = mysql_query ("SELECT title, meta_d, meta_k, text FROM set_table_sist WHERE page='cont'",$db);
                ...
                <table width="100%" border="0"  cellspacing="0" cellpadding="5">
                  <tr>
                   ...
                   <td valign="top" class="center">
                        		 ...
                        		 <table align="center" style="margin-top:100px;" width="900" border="0"  cellspacing="0" cellpadding="0">
                                 	<tr>
										<td>
                                        	<?php echo $row['text']; ?>
                                        </td>	
