...
//	}
	...
	if($kol > 0){
		...
		$html .= '
			<tr>
			<td align="left"><a target="_blank" href="http://tea.crimea.ua/goods.php?tovar='.$id2.'">'.$name.'</a></td>
...
$title = 'Заказ tea.crimea.ua №'.$id_ord.' '.$country_name.'  '.$summ.' '.$currency.' '.$kolSumm.' шт. ('.$type_arr[$type].')'; 
...
header("Location:http://tea.crimea.ua/orderok.php");
